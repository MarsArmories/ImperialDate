...
public class ImperialDateTests
{
    ...
    public void Now_IsNotNull()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing {current}");
    ...
    public void From_DateTime_Now_Should_Equal_Now()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing Now: {now} vs UTCNow: {dateTimeNow}");
    ...
    public void DateTime_MinValue_IsValid()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing {minValue}");
    ...
    public void DateTime_MaxValue_IsValid()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing {maxValue}");
    ...
    public void Valid_Ticks_Should_Not_Throw_Errors()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing Ticks: {dateAsTicks} vs {expected}");
    ...
    {
        var expected = new ImperialDate(CheckValue.Sol, 510, 20, 3);
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing Ticks: {badDateAsTicks} vs {expected}");
    ...
    {
        TestContext.Current.TestOutputHelper?.WriteLine($"CheckValue is {(CheckValue)checkValue}");
    ...
    public void ImperialDate_MinValue_Should_Be_Less_Than_MaxValue()
    {
        var minValue = ImperialDate.MinValue;
        var maxValue = ImperialDate.MaxValue;
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing minValue: {minValue} vs maxValue: {maxValue}");
    ...
    public void ImperialDate_MaxValue_Should_Be_Greater_Than_MinValue()
    {
        ...
        var maxValue = ImperialDate.MaxValue;
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing minValue: {minValue} vs maxValue: {maxValue}");
        TestContext.Current.TestOutputHelper?.WriteLine($"MinValue: {minValue} has ticks: {minValue.Ticks}");
        TestContext.Current.TestOutputHelper?.WriteLine($"MaxValue: {maxValue} has ticks: {maxValue.Ticks}");
    ...
    public void ImperialDate_Should_Greater_Than_Equal_Itself()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing now: {now} vs otherNow: {otherNow}");
        now.Should().BeGreaterThanOrEqualTo(otherNow);
    }
    ...
    public void ImperialDate_Should_Less_Than_Equal_Itself()
    {
        ...
        var otherNow = ImperialDate.From(DateTime.Now);
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing now: {now} vs otherNow: {otherNow}");
        now.Should().BeLessThanOrEqualTo(otherNow);
    }
    ...
    public void ImperialDate_Should_Throw_Exception_When_Comparing_Other_Objects()
    {
        ...
        object object2 = new();
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing object1 tpe: {object1.GetType()} vs object2 type: {object2.GetType()}");
    ...
    public void ImperialDate_NowAndDateTime_Now_Should_Have_Same_HashCode()
    {
        ...
        object otherNow = ImperialDate.From(DateTime.Now);
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing now: {now} vs otherNow: {otherNow}");
        now.GetHashCode().Should().Be(otherNow.GetHashCode());
    }
    ...
    public void ImperialDate_Now_Should_Return_Correct_Standard_Format()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine($"Testing now: {now.ToString("S")} vs otherNow: {standardFormat}");
